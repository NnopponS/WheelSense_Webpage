...
export const editablePages = [
  {
    ...
    fields: [
      ...
      { id: 'overview.label', label: 'Overview Label', selector: '#overviewDeck .overview-shell__label', type: 'text' },
      { id: 'overview.heading', label: 'Overview Heading', selector: '#overviewDeck .overview-shell__header h2', type: 'text' },
      { id: 'overview.description', label: 'Overview Description', selector: '#overviewDeck .overview-shell__description', type: 'text', multiline: true },
      ...
      { id: 'preview.label', label: 'Project Preview Label', selector: '#projectPreview .reveal p', type: 'text' },
      { id: 'preview.heading', label: 'Project Preview Heading', selector: '#projectPreview .reveal h2', type: 'text' },
      { id: 'preview.description', label: 'Project Preview Description', selector: '#projectPreview .reveal .text-body-lg', type: 'text', multiline: true },
